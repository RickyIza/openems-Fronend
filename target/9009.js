(self["webpackChunkopenems_ui"] = self["webpackChunkopenems_ui"] || []).push([[9009],{
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ 6959).then(__webpack_require__.bind(__webpack_require__, /*! ./tap-click-cc1ae2b2.js */ 96959)).then(module => module.startTapClick(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c));
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ 3465).then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-bdecfebf.js */ 23465)).then(module => module.startStatusTap());
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() */ 4908).then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-73f15161.js */ 4908)).then(module => module.startInputShims(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c));
        }
        ...
        if (typeof window !== 'undefined') {
          __webpack_require__.e(/*! import() */ 8354).then(__webpack_require__.bind(__webpack_require__, /*! ./keyboard-5742b5da.js */ 18354)).then(module => module.startKeyboardAssist(window));
        }
        __webpack_require__.e(/*! import() */ 6441).then(__webpack_require__.bind(__webpack_require__, /*! ./focus-visible-f4ad4f1a.js */ 16441)).then(module => module.startFocusVisible());
      });
    }
  }
  render() {
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await __webpack_require__.e(/*! import() */ 9773).then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-fae97365.js */ 89773))).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
